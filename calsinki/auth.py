...
from .config import get_credentials_path, get_config_dir
...
class GoogleAuthenticator:
    ...
    def authenticate(self) -> Credentials:
        ...
        if credentials and credentials.expired and credentials.refresh_token:
            try:
                ...
                print(f"⚠️  Refresh token expired for {self.account_name}, re-authenticating...")
    ...
    def _perform_device_flow(self) -> Credentials:
        ...
        print(f"⚠️  Note: You may see an error about redirect_uri - this is expected for mobile auth")
        print(f"    The important thing is that you complete the Google sign-in process")
        print(f"    After completing auth, you'll get an authorization code - copy it and paste it here")
...
def load_oauth2_config() -> Optional[OAuth2Config]:
